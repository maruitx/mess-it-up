...
int COBBEstimator::computeMinOBBByRot(int iFixAxis)
{
	...
	int num = m_CHV.size();
	double *points = new double[3*num];
	...
	switch (iFixAxis) {
		case -1: case 0: case 1:
			BEST_FIT::computeBestFitOBB(num, points, 3*sizeof(double), sides, matrix, BEST_FIT::FS_SLOW_FIT);
			break;
		case 2:
			BEST_FIT::computeBestFitOBB_FixZ(num, points, 3*sizeof(double), sides, matrix, BEST_FIT::FS_SLOW_FIT);
			break;
		default:
			BEST_FIT::computeBestFitOBB(num, points, 3*sizeof(double), sides, matrix, BEST_FIT::FS_SLOW_FIT);
			break;
