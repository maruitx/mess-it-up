...
public:
	...
	void computeFromBoundingBoxes(const std::vector<BoundingBox> &boxes);

	bool contains(const Vector3d& point) const;
	bool containsTriangle(const Vector3d& tv1, const Vector3d& tv2, const Vector3d& tv3) const;
	bool containsBoundingBox(BoundingBox &bb);

	bool intersectSegment(const Vector3d &startPt, const Vector3d &endPt);
